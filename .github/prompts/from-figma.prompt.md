...
Read and execute the skill at [`.developer/skills/design/from-figma/SKILL.md`](../../.developer/skills/design/from-figma/SKILL.md). Follow its Role, load the listed context,
