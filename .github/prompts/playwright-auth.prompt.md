...
Read and execute the skill at [`.developer/skills/testing/playwright/playwright-auth/SKILL.md`](../../.developer/skills/testing/playwright/playwright-auth/SKILL.md). Follow its Role, load the listed context,
